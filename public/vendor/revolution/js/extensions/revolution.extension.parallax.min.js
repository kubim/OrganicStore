        ...
        checkForParallax: function (a, e) {
            function g(a) {
                if ("3D" == f.type || "3d" == f.type) {
                    ...
                    d.appendTo(b), "carousel" == e.sliderType && ("on" == f.ddd_shadow && b.addClass("dddwrappershadow"), punchgs.TweenLite.set(b, {borderRadius: e.carousel.border_radius})), punchgs.TweenLite.set(a, {
                        overflow: "visible",
            ...
            var f = a.c[0].getBoundingClientRect(), g = a.viewPort, h = a.parallax,
            ...
            if ("3d" != h.type && "3D" != h.type) {
                if (("scroll" == h.type || "scroll+mouse" == h.type || "mouse+scroll" == h.type) && h.pcontainers) for (var k = 0; k < h.pcontainers.length; k++) if (h.pcontainers[k].length > 0) {
                    var l = h.pcontainers[k], m = h.pcontainer_depths[k] / 100,
                ...
                if (h.bgcontainers) for (var k = 0; k < h.bgcontainers.length; k++) {
                    var o = h.bgcontainers[k], p = h.bgcontainer_depths[k], n = i * -(p * a.conh) || 0;
            ...
            if (q.on && ("on" !== q.disable_on_mobile || !c)) {
                ...
                if (r = r < 0 ? 0 : r, q.layers !== !1) {
                    var s = 1 - r * q.multiplicator_layers, t = {backfaceVisibility: "hidden", force3D: "true"};
                ...
                if (q.bgs !== !1) {
                    var s = 1 - r * q.multiplicator, t = {backfaceVisibility: "hidden", force3D: "true"};
                    if ("top" == q.direction && i >= 0 && (s = 1), "bottom" == q.direction && i <= 0 && (s = 1), s = s > 1 ? 1 : s < 0 ? 0 : s, "on" === q.fade && (t.opacity = s), "on" === q.blur) {
                        var u = (1 - s) * q.maxblur;
                        t["-webkit-filter"] = "blur(" + u + "px)", t.filter = "blur(" + u + "px)"
                    }
