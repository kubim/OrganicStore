  ...
  render() {
      ...
      <div>
        ...
        <div style={{marginTop: '40px'}} className="sec-item flex-w">
          ...
          {/*  */}
          {this.state.categories.map((item,index) => { return (index>0 && index<4)?
        ...
        <div className="sec-product bg0 p-t-145 p-b-25">
          <div className="container">
            ...
            <div className="p-b-46">
              <div className="flex-w flex-c-m filter-tope-group">
                {this.state.categories.map((item,index) => { return (index<4)?
                  <button key={index} className="txt-m-104 cl9 hov2 trans-04 p-rl-27 p-b-10 how-active1" data-filter="*">
                    {item.name}
                  </button>
                :null})}
              </div>
            ...
            <div className="row isotope-grid">
              ...
              <div className="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item vegetable-fill other-fill">
                {/* Block1 */}
                <div className="block1">
                  <div className="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
              ...
              {/* - */}
              <div className="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item fruit-fill fruit-juic-fill">
                {/* Block1 */}
                <div className="block1">
                  <div className="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
